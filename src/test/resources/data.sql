...
insert into persona (id, dtype, correo, apellidos, nombre, telefono, tipo_id, password) values
...
insert into
    persona (id, dtype, tipo_id, nombre, apellidos, correo, telefono, password, proveedor_acceso)
