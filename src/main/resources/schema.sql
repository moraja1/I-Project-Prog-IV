...
create table direccion (id bigint not null auto_increment, canton varchar(255),
                        distrito varchar(255), provincia varchar(255), primary key (id)) engine=InnoDB;
...
create table informacion_comercial (id bigint not null auto_increment, nombre varchar(255), razon_social varchar(255),
                                    direccion_id bigint, primary key (id)) engine=InnoDB;
